...
sampleTable <- readRDS(paste0(paste("results/post/sampleTable", my_suffix, sep = "_"), ".rds"))
txi <- readRDS(paste0(paste("results/post/txi", my_suffix, sep = "_"), ".rds"))
...
resLFC_auto %>% plotMAplot(., ylim = c(-4, 4), filename = paste0("MAplot_shrunk_deltaTE_autonorm_", my_suffix, ".pdf"))
