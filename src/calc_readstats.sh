...
rm -rf results/post/readstats_ribo.csv

echo "sample,raw_reads,cutadapt_reads,collapse_reads,trim_reads,filter_reads,reads_mapped" > results/post/readstats_ribo.csv


for sample in $(tail -n +2 config/ribo_samples.csv)
do
	...
	echo "$sample,$var0,$var1,$var2,$var3,$var4,$var5" >> results/post/readstats_ribo.csv
done
