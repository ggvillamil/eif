...
saveRDS(sampleTable, paste0(paste("results/post/sampleTable_unique", my_suffix, sep = "_"), ".rds"))
saveRDS(txi, paste0(paste("results/post/txi_unique", my_suffix, sep = "_"), ".rds"))
