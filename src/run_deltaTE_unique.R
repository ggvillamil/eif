...
sampleTable <- readRDS(paste0(paste("results/post/sampleTable_unique", my_suffix, sep = "_"), ".rds"))
txi <- readRDS(paste0(paste("results/post/txi_unique", my_suffix, sep = "_"), ".rds"))
...
# Save results
saveRDS(res_auto, paste0("results/post/deseq_res_deltaTE_autonorm_unique_", my_suffix, ".rds"))
...
# MA plots
res_auto %>% plotMAplot(., ylim = c(-8, 8), filename = paste0("MAplot_deltaTE_autonorm_unique_", my_suffix, ".pdf"))
resLFC_auto %>% plotMAplot(., ylim = c(-4, 4), filename = paste0("MAplot_shrunk_deltaTE_autonorm_unique_", my_suffix, ".pdf"))
...
# Save results
saveRDS(res_manual, paste0("results/post/deseq_res_deltaTE_yeastnorm_unique_", my_suffix, ".rds"))
...
# MA plots
res_manual %>% plotMAplot(., ylim = c(-8, 8), filename = paste0("MAplot_deltaTE_yeastnorm_unique_", my_suffix, ".pdf"))
resLFC_manual %>% plotMAplot(., ylim = c(-4, 4), filename = paste0("MAplot_shrunk_deltaTE_yeastnorm_unique_", my_suffix, ".pdf"))
