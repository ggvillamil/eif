...
sampleTable <- readRDS(paste0(paste("results/post/sampleTable", my_suffix, sep = "_"), "_unique.rds"))
txi <- readRDS(paste0(paste("results/post/txi", my_suffix, sep = "_"), "_unique.rds"))
...
# Save results
saveRDS(res_auto, paste0("results/post/deseq_res_deltaTE_autonorm_", my_suffix, "_unique.rds"))
...
# MA plots
res_auto %>% plotMAplot(., ylim = c(-8, 8), filename = paste0("MAplot_deltaTE_autonorm_", my_suffix, "_unique.pdf"))
resLFC_auto %>% plotMAplot(., ylim = c(-4, 4), filename = paste0("MAplot_shrunk_deltaTE_autonorm_", my_suffix, "_unique.pdf"))
...
# Save results
saveRDS(res_manual, paste0("results/post/deseq_res_deltaTE_yeastnorm_", my_suffix, "_unique.rds"))
...
# MA plots
res_manual %>% plotMAplot(., ylim = c(-8, 8), filename = paste0("MAplot_deltaTE_yeastnorm_", my_suffix, "_unique.pdf"))
resLFC_manual %>% plotMAplot(., ylim = c(-4, 4), filename = paste0("MAplot_shrunk_deltaTE_yeastnorm_", my_suffix, "_unique.pdf"))
