...
ribostan_transcripts <- read_tsv("results/primary_ribostan/ribo_01_eIF3d_minusAux_minusHarr_4h_rep1_R1/primary_ribo_01_eIF3d_minusAux_minusHarr_4h_rep1_R1.ribostan.human_morf_quant.tsv") %>% .$Name
...
ribo_files <- paste0("results/primary_ribostan/", ribo_samples, "_R1/primary_", ribo_samples, "_R1.ribostan.human_morf_quant.tsv") # Again note the use of "_R1"
