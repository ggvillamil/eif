...
ribostan_transcripts <- read_tsv("results/unique_ribostan/ribo_01_eIF3d_minusAux_minusHarr_4h_rep1_R1/unique_ribo_01_eIF3d_minusAux_minusHarr_4h_rep1_R1.ribostan.human_morf_quant.tsv") %>% .$Name
...
ribo_files <- paste0("results/unique_ribostan/", ribo_samples, "_R1/unique_", ribo_samples, "_R1.ribostan.human_morf_quant.tsv") # Again note the use of "_R1"
...
saveRDS(sampleTable, paste0(paste("results/post/sampleTable", my_suffix, sep = "_"), "_unique.rds"))
saveRDS(txi, paste0(paste("results/post/txi", my_suffix, sep = "_"), "_unique.rds"))
